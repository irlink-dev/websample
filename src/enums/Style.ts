...
export enum Style {
  ...
  BUTTON_SOFT = `py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md bg-blue-100 border border-transparent font-semibold text-blue-500 hover:text-white hover:bg-blue-500 focus:outline-none focus:ring-2 ring-offset-white focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm `,
  ...
  CARD = `flex flex-col bg-white border shadow-sm rounded-xl p-5 dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7] dark:text-gray-400 `,
}

/** @todo ButtonStyle, InputStyle, CardStyle ... => MonoRepo Library */
